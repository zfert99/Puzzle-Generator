...
**Steps:**
1. Create buckets for 'easy', 'medium', and 'hard' puzzles.
...
4. Call `drawPuzzles(true)` to draw all the filled-in answer keys.
5. **Add Page Numbers:**
...
6. Tell the document we are finished (`doc.end()`), which triggers the final Buffer to be returned.
