...
> **Status:** 🚧 In Progress — **engine K0–K4 + all K5 surfaces (play/PDF/hub/daily) + a measured difficulty rebalance + Keisan minis in the daily rotation + K7a (9×9, 3 tiers)** shipped; Keisan is playable, printable, discoverable, and in the daily rotation at 4×4/6×6/9×9 ([walkthrough](keisan-walkthrough.md)). **K7 was re-sliced** after a 9×9 de-risk found maxSize-5/T5 infeasible and the solver capped at ~T2: **K7a** (3-tier 9×9 now — givens-gradient, no score band, generates in ≤ 38 ms p95) is done; **K7b** (bounded-recursion "T5", the keen.c transplant) and **K7c** (5-tier 9×9 via an offline pool) unlock Expert/Extreme next; then **K6** No-Op / Mystery. See [keisan-9x9-feasibility-findings.md](research/keisan-9x9-feasibility-findings.md) + the [honest-ladder research](research/compass_artifact_wf-feb5af89-67a1-51e8-bf2f-f348f76adfdd_text_markdown.md). Displayed as **Keisan** (internal slug `calc`). Full plan: [kenken-implementation-plan.md](kenken-implementation-plan.md), reviewed twice (reuse audit + [external plan review](research/kenken-plan-review.md), GREEN) + a [difficulty-calibration](research/kenken-difficulty-calibration.md) pass
