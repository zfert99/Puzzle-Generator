# Pre-Merge Log — August 2026 (rotated)

> **📦 Rotated out of [pre-merge-log.md](../pre-merge-log.md) on 2026-09-11.** These are the
> `/pre-merge` runs from 2026-08-03 through 2026-08-07, verbatim and newest first, moved because the
> live log had passed 2,500 lines. The live log keeps what carries forward — the **Known flaky
> tests** table and a **Standing lessons** digest distilled from these entries — so read those
> there; come here for the run itself. Nothing below was rewritten; only relative links were
> re-pathed because the file's depth changed.
