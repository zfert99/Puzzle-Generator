...
describe('generateDailyPuzzles', () => {
  // `rows` in the service is real puzzle generation for all 28 `DAILY_BOARDS` (killer-extreme
  ...
  // from redundantly regenerating the same 28 real boards three times over under load.
