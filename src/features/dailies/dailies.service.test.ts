...
describe('generateDailyPuzzles', () => {
  // `rows` in the service is real puzzle generation for all 29 `DAILY_BOARDS` (killer-extreme
  ...
  // from redundantly regenerating the same 29 real boards three times over under load.
